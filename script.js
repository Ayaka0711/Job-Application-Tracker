const jobs = [

  {
    ...
    type: "Full-Time",
    salary: "$70k - $90k",
    description: "Develop and maintain responsive React applications.",
    status: "none"
  },

  {
    id: 2,
    companyName: "WebFlex Agency",
    position: "Frontend Engineer",
    location: "New York",
    type: "Full-Time",
    salary: "$80k - $100k",
    description: "Work with UI/UX team to build scalable interfaces.",
    status: "none"
  },
...

  {
    ...
    type: "Part-Time",
    salary: "$50k - $65k",
    description: "Design modern UI components and prototypes.",
    status: "none"
  },
  ...
  {
    id: 7,
    companyName: "StartifyX",
    position: "Junior Developer",
    location: "Boston",
    type: "Internship",
    salary: "$40k - $50k",
    description: "Assist senior developers in projects.",
    status: "none"
  },

  {
    id: 8,
    companyName: "TechCore Industries",
    ...
    card.innerHTML = `
      ...
      <div class="flex justify-between">
        ...
        <div>
          ...
          <span class="inline-block mt-3 px-3 py-1 text-xs rounded-lg ${badgeStyle}">
            ${badgeText}
          </span>
